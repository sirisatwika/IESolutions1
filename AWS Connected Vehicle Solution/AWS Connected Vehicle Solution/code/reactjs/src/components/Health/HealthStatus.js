...
const headCells = [
  ...
  {
    id: "intake_manifold_absolute_pressure " ,
    numeric: true,
    disablePadding: false,
    label: 'Intake Manifold Absolute Pressure (kPa)',
  },
  {
    id: "engine_rpm" ,
    numeric: true,
  ...
  },
  {
    ...
    numeric: true,
    disablePadding: false,
    label: 'MAF Air Flowrate(g/s)',
  },
  {
    id: "vehicle_speed_mean " ,
    numeric: true,
    disablePadding: false,
    label: 'Vehicle Speed Mean(km/hr)',
  },
  {
    id: "troublecodes" ,
    numeric: true,
...
function HealthStatus(props) {
  ...
  const handleChangeData = e => {
   ...
   return axios
    .get(`http://18.211.145.178/apis/vehicles/${e.target.value}/healthreports`)
                      ...
                      .map((row, index) => {
                        ...
                        return (
                          <TableRow
                            ...
                            <TableCell>{row.engine_load}</TableCell>
                            {/* <TableCell>{row.acknowledged}</TableCell> */}
                            <TableCell>{row.engine_coolant_temp}</TableCell>
                            {/* <TableCell>{row.steps}</TableCell> */}
                            <TableCell>{row.fuel_pressure}</TableCell>
                            <TableCell>{row.intake_manifold_absolute_pressure}</TableCell>
                            <TableCell>{row.engine_rpm }</TableCell>
                            <TableCell>{row.intake_air_temperature }</TableCell>
                            <TableCell>{row.MAF_air_flowrate }</TableCell>
                            <TableCell>{row.vehicle_speed_mean }</TableCell>
                            <TableCell>{row.troublecodes  }</TableCell>
